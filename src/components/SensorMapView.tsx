      ...
      {activeSensor && (
        <div className="pointer-events-none absolute bottom-4 left-4 z-20 w-80 rounded-lg border border-slate-700 bg-slate-900/95 p-3.5 text-xs text-white shadow-2xl backdrop-blur-md">
          ...
          {activeSensor.roadSubmersionDepthM > 0 && (
            <div className="mt-1.5 rounded bg-red-950/70 p-1.5 text-[11px] font-medium text-red-200 border border-red-800/50 flex items-center gap-1.5">
              ...
              <span>Inundation Alert: Road corridor submerged by {activeSensor.roadSubmersionDepthM}m water!</span>
            </div>
          )}
        </div>
      )}
