...
export type MapLayer = 'grid' | 'contours' | 'edges' | 'nodes' | 'convoys';

export const ALL_MAP_LAYERS: Set<MapLayer> = new Set(['grid', 'contours', 'edges', 'nodes', 'convoys']);
...
export default function MapViewTopo({
  ...
  return (
    ...
    >
      ...
      {/* Note: Nodes and convoys are visually load-bearing for dispatcher orientation. Hiding nodes while showing convoys may be disorienting. */}
